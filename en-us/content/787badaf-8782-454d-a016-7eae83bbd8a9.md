...
To register a UDF as cluster-safe, you must call the  [xlfRegister (Form 1)](c730124c-1886-4a0f-8f06-79763025537d.md) callback function through the **Excel12** or **Excel12v** interface. For more information about these interfaces, see the [Excel4/Excel12](2404f10d-8641-4ee6-a909-1c5a26610f80.md) and [Excel4v/Excel12v](e3e96b98-c5a7-4625-95b6-a1e2d09c6d3d.md). Registering a UDF as cluster-safe through the  **Excel4** or **Excel4v** interface is not supported.
...
**Note**  You cannot declare a cluster-safe UDF as an asynchronous UDF.

A UDF can determine whether it is being run using a cluster connector by calling the  [xlRunningOnCluster](7662f255-4184-4af0-97f5-9a89347a201a.md) callback function.

****   **Contribute to this article**Want to edit or suggest changes to this content? You can edit and submit changes to  [this article](https://github.com/jhershey00/VBA_Excel_Test/OpenXMLCon/articles/787badaf-8782-454d-a016-7eae83bbd8a9.md) using GitHub.
