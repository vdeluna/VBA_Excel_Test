...
|:-----|:-----|:-----|:-----|
|Arg1|Required| **Variant**|Logical1,logical2,... - 1 to 30 conditions you want to test that can be either TRUE or FALSE.|
...
****   **Contribute to this article**Want to edit or suggest changes to this content? You can edit and submit changes to  [this article](https://github.com/jhershey00/VBA_Excel_Test/OpenXMLCon/articles/2e77bb7a-5393-2d54-c669-0c1f58a0bdfd.md) using GitHub.
